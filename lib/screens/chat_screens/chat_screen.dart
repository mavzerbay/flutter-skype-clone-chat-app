...
import 'package:skype_clone/utilities/call_utils.dart';
import 'package:skype_clone/utilities/permission.dart';
import 'package:skype_clone/utilities/universal_variables.dart';
import 'package:skype_clone/utilities/utils.dart';
                ...
                Flexible(
                  child: ListView(
                    children: <Widget>[
                      ModalTile(
                        title: "Medya",
                        subtitle: "Fotoğraf ve Video Paylaş",
                        icon: Icons.image,
                        onTap: () => pickImage(source: ImageSource.gallery),
                      ),
                      ModalTile(
                        title: "Belge",
                        subtitle: "Belge Paylaş",
                        icon: Icons.tab,
                      ),
                      ModalTile(
                        title: "Kişiler",
                        subtitle: "Kişi Paylaş",
                        icon: Icons.contacts,
                      ),
                      ModalTile(
                        title: "Konum",
